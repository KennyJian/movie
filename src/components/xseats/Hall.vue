    ...
    <div class="seats-block">
      ...
      <div class="seats-container">
        ...
        <div class="seats-wrapper">
          ...
          >
            <span
              :class="item.isSold == true ? 'seat sold' : item.selected == true ? 'seat selected' : 'seat selectable'"
  ...
  methods: {
    ...
    setSelectedFlag(item, limit) {
      ...
      if (item.selected == true) {
        ...
        if (
          this.$store.state.selectedSingleSeatList.length == limit ||
          this.$store.state.selectedCoupleSeatList.length == limit ||
          this.$store.state.selectedSingleSeatList.length +
            this.$store.state.selectedCoupleSeatList.length >=
            limit
        ) {
    ...
    selectCoupleSeat(rowIndex, columnIndex, seatId, items, limit) {
      ...
      if (columnIndex % 2 == 0) {
        ...
        params = {
          coupleSelected:
            items[columnIndex].selected || items[columnIndex + 1].selected,
          seatArr: [
            {
              row: rowIndex,
              seatId: seatId,
...
.hall {
  ...
  .seat-example {
    ...
    .example {
      ...
      margin-right: 50px;
      &.selectable-example {
        background: url("../../../static/imgs/selectable-seat.png") no-repeat;
      }
      &.sold-example {
        background: url("../../../static/imgs/sold-seat.png") no-repeat;
      }
      &.selected-example {
        background: url("../../../static/imgs/selected-seat.png") no-repeat;
      }
      &.couple-example {
        padding-left: 77px;
        background: url("../../../static/imgs/couple-seat.png") no-repeat;
      }
    }
  }
  .seats-block {
    ...
    .seats-container {
      ...
      .screen-container {
        ...
        .screen {
          ...
          font-size: 16px;
          color: #666;
          background: url("../../../static/imgs/screen-center.png") top center
            no-repeat;
          position: relative;
          margin-bottom: 40px;
        }
      ...
      .seats-wrapper {
        ...
        .row {
          ...
          .seat {
            ...
            &.lover {
              width: 35px;
              background: url("../../../static/imgs/couple-selectable-seat.png")
                no-repeat;
              &.selected {
                background: url("../../../static/imgs/couple-selected-seat.png")
                  no-repeat;
              }
              &.lover-left {
                margin-right: 0;
