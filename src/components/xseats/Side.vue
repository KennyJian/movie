<template>
  <div class="side" v-if="fieldInfo">
    ...
    <div class="ticket-info">
      <div
        class="has-ticket"
        v-if="($store.state.selectedSingleSeatList && $store.state.selectedSingleSeatList.length > 0) ||
      ...
      >
        ...
        <div class="ticket-container">
          <span
            class="ticket"
            v-for="(item, indexSingle) in $store.state.selectedSingleSeatList"
          ...
          <span
            class="ticket"
            v-for="(item, indexCouple) in $store.state.selectedCoupleSeatList"
      ...
      <div class="modal">
        ...
        <p
          ...
          v-if="fieldInfo && fieldInfo.data
                                    ...
                                    && fieldInfo.data.hallInfo.seatFile
                                    && fieldInfo.data.hallInfo.seatFile.limit"
        >一次最多购买{{fieldInfo.data.hallInfo.seatFile.limit}}张票</p>
  ...
  .ticket-info {
    ...
    .ticket-container {
      ...
      .ticket {
        ...
        &:hover {
          .btn-delete {
            background: url(../../../static/imgs/icon-close.png) no-repeat;
            width: 16px;
            height: 16px;
...
.modal-container {
  ...
  .modal {
    ...
    .icon {
      ...
      width: 50px;
      height: 50px;
      background: url("../../../static/imgs/icon-warn.png") no-repeat;
    }
    .tip {
      font-size: 14px;
      color: #666;
